...
const Login = () => {
    ...
    const { loginUser, login, handleLogin, isLoggedIn, signInWithGoogle } = useGlobalContext();
            ...
            <div className="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
                    ...
                    <form onSubmit={login}>
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input id="email" type="email" value={loginUser.email} onChange={handleLogin} name="email" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="E-Mail Address" />
                            </div>
                        </div>
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input id="password" type="password" value={loginUser.password} onChange={handleLogin} name="password" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Password" />
                            </div>
                        </div>
                ...
                <div className="flex justify-center items-center mt-6">
                    <Link to="/signup" className="inline-flex items-center font-bold text-blue-500 hover:text-blue-700 text-xs text-center">
                        ...
                        <span className="ml-2">You don't have an account? Singup</span>
                    </Link>
                </div>
            </div>
        </div>
